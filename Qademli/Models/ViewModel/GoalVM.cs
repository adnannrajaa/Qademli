...
namespace Qademli.Models.ViewModel
{
    public class GoalVM
    {
        ...
        public Goal Add(GoalUpsert obj)
        {
            ...
            {
                var imageName = ImageHelper.UploadImageFile(_hostEnvironment, "wwwroot/Uploads/Goal", obj.Image);
                if (imageName != null)
                {
        ...
        public void Delete(Goal goal)
        {
            ...
            {
                ImageHelper.DeleteImage(_hostEnvironment, @"Uploads\Goal", goal.Image);
            }
        }
