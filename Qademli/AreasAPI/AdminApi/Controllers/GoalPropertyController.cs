...
namespace Qademli.AreasAPI.AdminApi.Controllers
{
    ...
    public class GoalPropertyController : ControllerBase
    {
        ...
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost]
        public ActionResult PostGoalProperty([FromForm]GoalProperty goalProperty)
        {
            var isPropExist = _context.GoalProperty.FirstOrDefault(s => s.Name == goalProperty.Name);
            if (isPropExist != null)
            {
                return NoContent();
            }
