...
namespace Qademli.AreasAPI.AdminApi.Controllers
{
    ...
    public class ApplicationController : ControllerBase
    {
        ...
        public ApplicationController(ApplicationDBContext context, IHubContext<ApplicationHub> hubContext)
        {
            _context = context;
        ...
        public async Task<ActionResult<Application>> PostApplication(Application application)
        {
            ...
            await _context.SaveChangesAsync();
            await _hubContext.Clients.All.SendAsync("ReceiveMessage", "umer", "adnan");
